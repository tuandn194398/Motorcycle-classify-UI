...
from src.models.low_light_enhance.Blocks import Mlp
...
class query_Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        q = (
            self.q.expand(B, -1, -1)
            .view(B, -1, self.num_heads, C // self.num_heads)
            .permute(0, 2, 1, 3)
        )
