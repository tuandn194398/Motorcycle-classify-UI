...
from src.models.low_light_enhance.Blocks import CBlock_ln, SwinTransformerBlock
from src.models.low_light_enhance.GlobalNet import GlobalPred
...
class IAT(nn.Module):
    def __init__(self, in_dim=3, with_global=True, type="lol"):
        ...
        if self.with_global:
            self.global_net = GlobalPred(in_channels=in_dim, type=type)
